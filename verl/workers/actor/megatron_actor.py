...
class MegatronPPOActor(BasePPOActor):
    ...
    def make_minibatch_iterator(self, data: DataProto) -> Iterable[DataProto]:
        ...
        # Tango-style multi-component advantages (optional):
        # If provided by the trainer, we compute *separate* PPO/GRPO clipped
        # policy losses for structure+select and correctness, then sum them.
        ...
        def loss_func(output, data, meta_info):
            ...
            if not forward_only:
                ...
                if use_component_adv:
                    ...
                    # 2) correctness (may be scaled for numerical tasks)
